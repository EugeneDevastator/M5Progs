...
BlockExporterController.prototype.updatePreview = function() {
  ...
  var blockDefsm5 = this.getBlockDefinitionsOfSelectedM5();
  var genStubs = this.getGeneratorStubsOfSelected();

  // Update the text areas containing the code.
  FactoryUtils.injectCode(blockDefsm5, 'blockDefs_textArea');
...
BlockExporterController.prototype.getBlockDefinitionsOfSelectedM5 = function() {
  // Get selected blocks' information.
  var blockXmlMap = this.getSelectedBlockXmlMap();

  return this.tools.getBlockDefinitions(blockXmlMap, "M5");
};
