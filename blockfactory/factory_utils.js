...
FactoryUtils.getBlockDefinition = function(blockType, rootBlock, format, workspace) {
  ...
  switch (format) {
    case 'M5':
      var code = "var __"+this.GetLibName()+"_"+blockType+"_json="+FactoryUtils.formatJson_(blockType, rootBlock)+";";
      break;
    case 'JSON':
...
FactoryUtils.GetLibName = function() {
  return document.getElementById('lib_name').value
};
/**
